  ...
  <div class="hero-inner">
    <div class="hero-left">
      ...
      <div class="hero-btns">
        ...
        <a class="btn btn-outline btn-lg" href="#kontak">Konsultasi Gratis</a>
      </div>
      <div class="hero-trust">
        <div class="trust-avatars"><span>R</span><span>A</span><span>S</span></div>
        <div class="trust-text">
          <strong>1000+ alumni ditempatkan</strong>
    ...
    <div class="hero-right">
      ...
      <div class="hero-card hero-badge-1">
        ...
        <div class="hb-label">Tingkat Penempatan</div>
      </div>
      <div class="hero-card hero-badge-2">
        ...
        <div class="hb-label">Tahun Pengalaman</div>
      </div>
      <div class="jp-flag">
        <span class="flag">🇯🇵</span>
        <div>
          <div style="font-size:13px;font-weight:800;">Berangkat ke Jepang</div>
          <div style="font-size:11px;color:var(--muted);">Program resmi SSW/TG</div>
        </div>
      </div>
    </div>
  </div>
...
<div class="stats-strip">
  <div class="stats-inner container">
    <div class="stat-item"><div class="stat-num">1000<span>+</span></div><div class="stat-lbl">Alumni Ditempatkan</div></div>
    <div class="stat-item"><div class="stat-num">98<span>%</span></div><div class="stat-lbl">Tingkat Keberhasilan</div></div>
    <div class="stat-item"><div class="stat-num">10<span>+</span></div><div class="stat-lbl">Tahun Pengalaman</div></div>
    <div class="stat-item"><div class="stat-num">4</div><div class="stat-lbl">Program Tersedia</div></div>
  </div>
</div>
